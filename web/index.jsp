...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
    ...
    <body>
       <nav class="navbar navbar-light" style="background-color: #46b8da">
           <a href="index.jsp"><img src="img/train.png" width="50" height="50"></a>
           Hott'oys
           <a href="index.jsp"><img src="img/train.png" width="50" height="50"></a>
           ...
           <div class="dropdown pull-right">
            ...
            <ul class="dropdown-menu">
                ...
                <form action="Admin" method="Post">
                    <font size="4" color="red">${mensagem}</font><br>
                    
                    <label for="adminlogin">Nome: </label><input type="text" id="adminlogin" name="adminlogin" maxlength="30" placeholder="Login" required name=adminlogin>
                    <label for="adminlogin">Senha: </label><input type="password" id="adminsenha" name="adminsenha" maxlength="30" placeholder="Senha" required name=adminsenha><br><br>
